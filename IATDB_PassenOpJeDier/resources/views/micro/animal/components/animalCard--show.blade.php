<article class="showCard  a-popup" data-species-of-animal={{$animals->species}}>
    <header class="showCard__header u-flex-v-center">
        ...
        <section class="showCard__buttonSection u-flex-v-center">
            <button class="showCard__button showCard__button-pick u-flex-v-center" onclick="window.location.href='/micro/application'">Op {{$animals->name}} passen</button>
            ...
            <button class="showCard__button showCard__button-back u-flex-v-center" onclick="window.location.href='/micro/animals'">Terug naar overzicht</button>
        </section>
